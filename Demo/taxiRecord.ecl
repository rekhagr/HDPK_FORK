...
EXPORT taxiRecord := MODULE
	...
	EXPORT taxiRecordLayout := RECORD 
		UNSIGNED4 date;
    ...
    EXPORT taxiRecordDs := DATASET(PATH, taxiRecordLayout, FLAT);

   
    
    EXPORT taxiRecordMeta := DATASET([{'name','fileType', 'filePath', 'format', 'isChildLayout', 
